...
Lo siguiente fue la configuracion de Lambda: 
...
El siguiente archivo que cree fue el rol.tf, aqui es donde doy los permisos y politicas:
...
En el siguiente paso creo la infraestructura para lambda en el archivo lambda_function.py, aca directamente le pedi a la IA que cree la funcion completa ya que yo aun no domino Phyton.

Lo siguiente fue crear un recurso de Logs porque al querer ver los registro desde cloudwatch no aparecian asi que, directamente hice que cree el log.
Por último cree en el archivo sns.tf cree el recurso para sns_topic para que me envie una notificacion una vez elaborado el mp3.
